(function ($) {
    $.fn.fakeLoader = function (options) {
        ...
        var settings = $.extend({ timeToHide: 1200, pos: "fixed", top: "0px", left: "0px", width: "100%", height: "100%", zIndex: "999", bgColor: "#2ecc71", spinner: "spinner7", imagePath: "", blockMode: false, release: false }, options);
        ...
        var el = $(this);
        var initStyles = { position: settings.pos, width: settings.width, height: settings.height, top: settings.top, left: settings.left };
        el.css(initStyles);
        el.each(function () {
        ...
        return this.css({ backgroundColor: settings.bgColor, zIndex: settings.zIndex });
    };
    function centerLoader() {
        ...
        $(".fl").css({ position: "absolute", left: "50%", top: "50%", width: "256px", height: "256px", margin: "-128px 0px 0px -128px" });
    }
